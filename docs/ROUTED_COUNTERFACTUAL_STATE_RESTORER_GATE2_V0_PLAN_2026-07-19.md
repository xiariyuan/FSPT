...
## Final status — 2026-07-19

Gate 2 completed in primary and exact independent replay. The formal decision is
`STOP_LEARNED_STATE_RESTORER_BEFORE_MODEL_VALIDATION`; source indices `48–63`
remain locked. See
`docs/ROUTED_COUNTERFACTUAL_STATE_RESTORER_GATE2_RESULT_2026-07-19.md` and
`docs/generated/ROUTED_COUNTERFACTUAL_STATE_RESTORER_TRAINING_SUMMARY_2026-07-19.json`.

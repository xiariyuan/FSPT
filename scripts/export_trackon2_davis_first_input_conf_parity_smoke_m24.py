...
def build_parity_record(old_record: dict, predictor: Predictor, device: torch.device) -> dict:
    ...
    nr['adapter_version'] = 'trackon2_forward_online_conf_parity_smoke_m24_v1'
...
def main() -> None:
    ...
    out_cache = OUT_DIR / 'trackon2_davis_first_input_conf_parity_smoke_m24_1video.pt'
    out_report = OUT_DIR / 'trackon2_davis_first_input_conf_parity_smoke_m24_1video_report.json'
    payload = dict(old)
    payload['schema_version'] = 'trackon2_forward_online_conf_parity_smoke_m24_v1'

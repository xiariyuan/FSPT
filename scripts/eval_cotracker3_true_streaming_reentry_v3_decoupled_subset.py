...
DEFAULT_OUTDIR = ROOT / 'outputs/paper_discovery_2026-07-05/cotracker3_true_streaming_v3_decoupled_subset_eval'
...
def run_variant(model: CoTrackerOnlinePredictor, base_record: dict, video: torch.Tensor, queries_xy: torch.Tensor, variant: str, params: dict):
    ...
    state_stats_total = {'candidate_frames': 0, 'opened_frames': 0, 'rejected_jump': 0, 'rejected_short': 0, 'rejected_score': 0, 'rejected_trend': 0, 'rejected_unstable_reentry': 0, 'rejected_not_allowed': 0}
    ...
    output_stats = {'candidate_frames': 0, 'opened_frames': 0, 'rejected_jump': 0, 'rejected_short': 0, 'rejected_score': 0, 'rejected_trend': 0, 'rejected_unstable_reentry': 0, 'rejected_not_allowed': 0}
...
def main():
    ...
    for variant in variants:
        ...
        payload['schema_version'] = 'cotracker3_true_streaming_reentry_v3_decoupled_subset_v1'
    ...
    report = {
        'script': 'scripts/eval_cotracker3_true_streaming_reentry_v3_decoupled_subset.py',
        'params': params,
    ...
    out_report = outdir / 'cotracker3_true_streaming_reentry_v3_decoupled_subset_report.json'

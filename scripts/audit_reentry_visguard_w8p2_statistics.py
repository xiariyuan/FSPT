...
OUTDIR = ROOT / 'reentry_visguard_w8p2_statistics'
...
SETTINGS: Dict[str, Dict[str, Path]] = {
    'rgb_fresh20_49_natural': {
        ...
        'full_w8p2': ROOT/'rgb_stacking_fresh20_49_natural_ablation/b2_w8_p2_rgb_fresh20_49.pt',
        'vis_w8p2': ROOT/'reentry_visguard_sweep/rgb_fresh20_49_natural/visguard_w8_p2.pt',
        'full_w16p2': ROOT/'rgb_stacking_fresh20_49_natural_ablation/b2_w16_p2_rgb_fresh20_49.pt',
        'vis_w16p2': ROOT/'reentry_visguard_sweep/rgb_fresh20_49_natural/visguard_w16_p2.pt',
    ...
    'fresh20_49_translate_L16': {
        ...
        'full_w8p2': ROOT/'reentry_visguard_sweep/fresh20_49_translate_L16/full_variants/b2_w8_p2.pt',
        'vis_w8p2': ROOT/'reentry_visguard_sweep/fresh20_49_translate_L16/visguard_w8_p2.pt',
        'full_w16p2': ROOT/'reentry_visguard_sweep/fresh20_49_translate_L16/full_variants/b2_w16_p2.pt',
        'vis_w16p2': ROOT/'reentry_visguard_sweep/fresh20_49_translate_L16/visguard_w16_p2.pt',
    ...
    'fresh20_49_occluder_L16': {
        ...
        'full_w8p2': ROOT/'reentry_visguard_sweep/fresh20_49_occluder_L16/full_variants/b2_w8_p2.pt',
        'vis_w8p2': ROOT/'reentry_visguard_sweep/fresh20_49_occluder_L16/visguard_w8_p2.pt',
        'full_w16p2': ROOT/'reentry_visguard_sweep/fresh20_49_occluder_L16/full_variants/b2_w16_p2.pt',
        'vis_w16p2': ROOT/'reentry_visguard_sweep/fresh20_49_occluder_L16/visguard_w16_p2.pt',
...
def aggregate(perv: Dict[str, Dict[str, float]]) -> Dict[str, Any]:
    ...
    out: Dict[str, Any] = {'n_videos': len(perv)}
    for m in metrics:
...
def main() -> None:
    ...
    for setting, paths in SETTINGS.items():
        ...
        aggs = {k: aggregate(v) for k, v in perv.items()}
        pairs = [
            ('vis_w8p2', 'offline'),
            ('vis_w8p2', 'full_w8p2'),
            ('vis_w8p2', 'full_w16p2'),
        ...
        results.append({'setting': setting, 'paths': {k: str(v) for k, v in paths.items()}, 'aggregates': aggs, 'comparisons': comps})
    summary = {
        'method': 'ReEntry-VisGuard-W8P2',
        'definition': 'offline/base coordinates + B2-W8-P2 predicted visibility in predicted re-entry windows',
        'results': results,
    }
    ...
    for r in results:
        compact.append({
            'setting': r['setting'],
            'aggregates': {k: {m: r['aggregates'][k][m] for m in ['AJ_RD_256','AJ_256','OA_256']} for k in ['offline','full_w8p2','vis_w8p2','full_w16p2','vis_w16p2','guard','guard_vis']},
            'vis_w8p2_vs_offline_AJRD': r['comparisons']['vis_w8p2_vs_offline']['AJ_RD_256'],
            'vis_w8p2_vs_full_w8p2_AJRD': r['comparisons']['vis_w8p2_vs_full_w8p2']['AJ_RD_256'],
            'vis_w8p2_vs_full_w16p2_AJRD': r['comparisons']['vis_w8p2_vs_full_w16p2']['AJ_RD_256'],
        })

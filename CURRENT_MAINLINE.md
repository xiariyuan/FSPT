...
Gate 3C1F2 v0 completed with exact replay and failed the frozen full-population
gates. On 128 third-population videos, AJ gain is +0.0014 points with CI
[-0.0340,+0.0435], delta_avg gain is +0.0937 points with positive CI, and OA
gain is +0.1591 points with positive CI. Among 51 evaluable actions, future
error reduction is +15.2680 px, 98.04% are positive, and none is harmful by more
...
Gate 3C1G0 richer visibility cache completed and passed. A 19-D grouped-OOF
probe remained insufficient: the best pooled action-frame AJ was 0.09816 versus
the frozen 0.09245 baseline, with 68.94% occluded false positives. The formal
66-D cache now contains all 44 exposed action videos, 89 sealed actions, and 801
frame rows. All entry/candidate/action/coordinate/visibility digests, sidecar
files, tensor hashes, and payloads verify exactly; labels remain outside the
causal feature channels. Formal decision:
AUTHORIZE_GATE3C1G1_NESTED_VIDEO_OOF_PREREGISTRATION. This exposed cache cannot
